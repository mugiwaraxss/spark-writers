<x-layout-writer>
    ...
    <div class="mb-6">
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-zinc-900">
            ...
            <div class="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-900">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-600 dark:text-blue-400">
                            <p>These orders match your expertise areas: <strong>{{ implode(', ', $writer_expertise) }}</strong>. You can claim orders that match your expertise to start working on them.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @else
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center dark:border-gray-700 dark:bg-gray-800">
                    <p class="text-gray-500 dark:text-gray-400">There are currently no orders available that match your expertise areas.</p>
                    <p class="mt-2 text-gray-500 dark:text-gray-400">Please check back later or update your expertise areas in your profile settings.</p>
                </div>
            @endif
        </div>
    </div>
