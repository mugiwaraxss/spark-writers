                ...
                <div class="hidden w-64 flex-shrink-0 bg-gray-50 lg:block">
                    <nav class="flex h-full flex-col">
                        <div class="space-y-1 p-4">
                            ...
                            <a href="{{ route('writer.profile') }}" class="flex items-center rounded-lg px-4 py-2 text-sm font-medium {{ request()->routeIs('writer.profile') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }}">
