<x-admin-layout>
    <x-slot:header>Add New Writer</x-slot:header>

    <div class="mx-auto max-w-3xl">
        <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
            <form action="{{ route('admin.writers.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label for="experience" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Years of Experience</label>
                        ...
                        <div>
                            ...
                            <input type="number" id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate') }}" min="5" max="100" required
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                            @error('hourly_rate')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="expertise_areas[]" value="essays" class="text-blue-600 focus:ring-blue-500"
                                            {{ in_array('essays', old('expertise_areas', [])) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="expertise_areas[]" value="research_papers" class="text-blue-600 focus:ring-blue-500"
                                            {{ in_array('research_papers', old('expertise_areas', [])) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="expertise_areas[]" value="dissertations" class="text-blue-600 focus:ring-blue-500"
                                            {{ in_array('dissertations', old('expertise_areas', [])) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="expertise_areas[]" value="technical_writing" class="text-blue-600 focus:ring-blue-500"
                                            {{ in_array('technical_writing', old('expertise_areas', [])) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="expertise_areas[]" value="creative_writing" class="text-blue-600 focus:ring-blue-500"
                                            {{ in_array('creative_writing', old('expertise_areas', [])) ? 'checked' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="bio" name="bio" rows="4"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('admin.writers.index') }}" class="rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200">
                        Cancel
                    </a>
